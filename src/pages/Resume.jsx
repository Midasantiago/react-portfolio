    ...
    return (
        <div className='max-w-xl mx-auto mt-8 p-4 bg-gray-800 text-white'>
            <h2 className='text-2xl font-bold mb-4'> 
                <a href='../../assets/resume/SantiagoResume.docx' download="SantiagoResume.docx" className='block bg-blue-500 text-white py-2 px-4 rounded text-center hover:bg-blue-600 transition duration-300'>
                    Download Resume
                </a>
            </h2>
